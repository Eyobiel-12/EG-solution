  ...
  let projects: Project[] = [
    {
      ...
      type: "E-commerce",
      description: t("portfolio.bsmFurniture.description", "Premium furniture e-commerce platform with 3D product visualization and seamless checkout experience."),
      image: "/images/bsm-furniture-logo.jpeg",
      technologies: ["Next.js", "JavaScript", "CSS", "Bootstrap", "MongoDB"],
      completionPercentage: 100,
      timeline: t("portfolio.bsmFurniture.timeline", "Completed in 2023"),
    },
    {
      id: "moso-basmara",
      title: "Moso Basmara",
      ...
      type: "Restaurant",
      description: t("portfolio.mosoBasmara.description", "Restaurant website with online menu, reservation system, and event booking functionality."),
      image: "/images/mosob-asmara-logo.jpeg",
      testimonial: {
        text: t("portfolio.mosoBasmara.testimonial", "EG Web Solutions transformed our online presence. Our customers love the new reservation system!"),
        author: "Moso Basmara",
        position: t("portfolio.mosoBasmara.position", "Owner"),
      },
      completionPercentage: 100,
      timeline: t("portfolio.mosoBasmara.timeline", "Completed in 2022"),
      featured: true,
    },
    {
      id: "savanna-eetcafe",
    ...
    },
    {
      ...
      type: "Restaurant",
      description: t("portfolio.axumRestaurant.description", "Elegant Ethiopian restaurant website showcasing ancient Axum heritage, featuring online reservations, digital menu, and authentic Ethiopian coffee ceremony experiences."),
      image: "/images/axum-logo.jpg",
      technologies: restaurantTechStack,
      completionPercentage: 100,
      featured: true,
      testimonial: {
        text: t("portfolio.axumRestaurant.testimonial", "EG Web Solutions perfectly captured our vision of blending ancient heritage with modern dining experience."),
        author: "Axum Restaurant",
        position: t("portfolio.axumRestaurant.position", "Management"),
      },
      timeline: t("portfolio.axumRestaurant.timeline", "Completed in 2025"),
    },
    {
      id: "kapsalon-stars",
      ...
      type: "Hair Salon",
      description: t("portfolio.kapsalonStars.description", "Hair salon website with appointment booking system and service showcase."),
      image: "https://kapsalonstars.nl/logo.png",
      technologies: ["Next.js", "JavaScript", "Bootstrap", "SQLite"],
      completionPercentage: 100,
      timeline: t("portfolio.kapsalonStars.timeline", "Completed in 2023"),
    },
    {
      id: "habesha-dating",
      ...
      description: t("portfolio.habeshaDating.description", "A specialized dating platform for the Habesha community with cultural matching algorithms and secure messaging."),
      status: t("portfolio.inDevelopment", "In Development"),
      image: "/images/habesha-dating-logo.jpeg",
      technologies: ["React Native", "Next.js", "JavaScript", "MongoDB", "Firebase"],
      completionPercentage: 65,
      featured: true,
      timeline: t("portfolio.habeshaDating.timeline", "end of 2025"),
    },
    {
      id: "work-management",
      ...
      description: t("portfolio.workManagement.description", "Comprehensive project management tool with task tracking, team collaboration, and performance analytics."),
      image: "/Screenshot 2025-06-28 at 14.17.17.png",
      technologies: [
        "Next.js",
        "React",
        "Firebase",
      ...
      completionPercentage: 100,
      timeline: t("portfolio.workManagement.timeline", "Completed in 2024"),
      featured: true,
    },
    {
      id: "asmera-shop",
      ...
      url: "#",
      type: "E-commerce",
      description: t("portfolio.asmeraShop.description", "Modern Shopify webshop built with Liquid, offering a seamless online shopping experience with custom themes and advanced e-commerce features."),
      status: t("portfolio.comingSoon", "Coming Soon"),
      image: "/Screenshot 2025-06-28 at 14.19.36.png",
      technologies: ["Shopify", "Liquid", "JavaScript", "CSS", "HTML"],
      completionPercentage: 85,
      timeline: t("portfolio.asmeraShop.timeline", "Coming Soon"),
      featured: true,
    },
    {
      id: "romys-touch",
      title: "Romy's Touch",
      url: "https://www.romystouch.nl",
      type: "Nail Salon",
      description: t("portfolio.romysTouch.description", "Professional nail salon website with built-in calendar system for appointments, built with WordPress for easy management and updates."),
      image: "/Screenshot 2025-06-28 at 14.25.46.png",
      technologies: ["WordPress", "PHP", "JavaScript", "CSS", "MySQL"],
      completionPercentage: 100,
      timeline: t("portfolio.romysTouch.timeline", "Completed in 2024"),
      featured: true,
    },
    {
      ...
      url: "#",
      type: "Restaurant",
      description: t("portfolio.restaurantWebsite.description", "Modern restaurant website with online menu, reservation system, and elegant design showcasing culinary excellence."),
      status: t("portfolio.comingSoon", "Coming Soon"),
      image: "/Screenshot 2025-06-28 at 14.23.13.png",
      technologies: restaurantTechStack,
      completionPercentage: 75,
      timeline: t("portfolio.restaurantWebsite.timeline", "Coming Soon"),
      featured: true,
    },
    {
      ...
      url: "#",
      type: "E-commerce",
      description: t("portfolio.ecommercePlatform.description", "Full-featured online shopping experience with product management, secure payments, and inventory tracking."),
      status: t("portfolio.inDevelopment", "In Development"),
      image: "/placeholder.svg?height=600&width=800",
      technologies: ["Next.js", "React Native", "JavaScript", "Supabase", "Firebase"],
      completionPercentage: 75,
      timeline: t("portfolio.ecommercePlatform.timeline", "end of 2025"),
    },
    {
      ...
      url: "#",
      type: "Healthcare",
      description: t("portfolio.healthcarePortal.description", "Comprehensive medical services platform for patient management, appointments, and secure health records."),
      status: t("portfolio.inDevelopment", "In Development"),
      image: "/placeholder.svg?height=600&width=800",
      technologies: ["React Native", "Next.js", "JavaScript", "MongoDB", "Bootstrap"],
      completionPercentage: 50,
      timeline: t("portfolio.healthcarePortal.timeline", "end of 2025"),
    },
    {
      id: "real-estate",
      ...
      url: "#",
      type: "Real Estate",
      description: t("portfolio.realEstate.description", "Property listing and management platform with virtual tours, agent profiles, and mortgage calculator."),
      status: t("portfolio.inDevelopment", "In Development"),
      image: "/placeholder.svg?height=600&width=800",
